                ...
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <div class="breadcrumb__option">
                            ...
                            <a href="{{ route('homepage') }}">Vegetables</a>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large" src="{{ $product->gallery->first()->getUrl() }}"
                                alt="">
                        </div>
                        <div class="product__details__pic__slider owl-carousel">
                            @foreach ($product->getMedia('gallery') as $gallery)
                                <img data-imgbigurl="{{ $gallery->getUrl() }}" src="{{ $gallery->getUrl() }}"
                                    alt="">
                            @endforeach
                        </div>
                    </div>
